...
public class PlatformerController2DClass : MonoBehaviour
{
    ...
    private void Move(float moveScalar)
    {
        _rigidbody.velocity = new Vector2(moveScalar * walkSpeed, _rigidbody.velocity.y);
